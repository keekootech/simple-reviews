...
INSERT INTO "new_Settings" ("customCss", "delayDays", "emailBody", "emailSubject", "headerColor", "id", "logoSize", "logoUrl", "shop", "textColor", "updatedAt") SELECT "customCss", "delayDays", "emailBody", "emailSubject", "headerColor", "id", "logoSize", "logoUrl", "shop", "textColor", "updatedAt" FROM "Settings";
DROP TABLE "Settings";
